...
app.listen(PORT, () => {
    ...
    console.log(color("> Rest api ini dibuat oleh ``Ririn Vieux``",'white'))
    console.log(color("> Buy rest api no pasaran bisa beli di Ririn,",'white'))
    console.log(color("> Whatsapp :","red"), color("\n › no : 62838-9968-4835\n › link : https://wa.me/6283899684835",'white'))
    console.log(color("> Email :","red"), color("\n › email : ririnvieux@gmail.com\n › link : mailto:ririnvieux@gmail.com",'white'))
