...
let anu = await fetchJson(`https://api.lolhuman.xyz/api/facebook?apikey=gatadios&url=${url}`)
res.json({
status: true,
creator: `${creator}`,
result: anu.result
...
if (!apikey) return res.json(loghandler.notapikey)
if(listkey.includes(apikey)){
let anu = await fetchJson(`https://toxicdevilapi.vercel.app/downloader/tiktok?url=${url}`)
res.json({
status: true,
creator: `${creator}`,
result: anu.result
...
if (!apikey) return res.json(loghandler.notapikey)
if(listkey.includes(apikey)){
let anu = await fetchJson(`https://apiaku.vercel.app/pinterest?query=${q}`)
res.json({
status: true,
creator: `${creator}`,
result: anu.result
